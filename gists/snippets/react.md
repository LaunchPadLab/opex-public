...
```
{
	...
	*/
	...
	"React LP Form Component": {
		...
		"Formik Form": {
		"prefix": "reactFormikFormComponent",
		"body": [
			"import React from 'react'",
			"import PropTypes from 'prop-types'",
			"import exact from 'prop-types-exact'",
			...
			"})",
			"",
			"function ${1:MyFormComponent}({ onSubmit, initialValues }) {",
			"\treturn (",
			"\t\t<Formik",
			...
			"}",
			"",
			"${1:MyFormComponent}.propTypes = exact(propTypes)",
			"${1:MyFormComponent}.defaultProps = defaultProps",
			"",
			"export default React.memo(${1:MyFormComponent})",
		],
		"description": "LP-Formik-Yup-Form component"
	}
}
```
